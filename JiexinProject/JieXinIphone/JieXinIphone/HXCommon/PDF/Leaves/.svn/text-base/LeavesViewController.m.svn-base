...
- (id)init {
    if (self = [super init]) {
		...
		//Raik modify
		//leavesView.mode = LeavesViewModeSinglePage;//UIInterfaceOrientationIsPortrait(self.interfaceOrientation) ? LeavesViewModeSinglePage : LeavesViewModeFacingPages;
	}
    return self;
}
...
- (void)loadView {
	...
	//[leavesView setTransform:CGAffineTransformMakeRotation(-M_PI/2.0)];
}
