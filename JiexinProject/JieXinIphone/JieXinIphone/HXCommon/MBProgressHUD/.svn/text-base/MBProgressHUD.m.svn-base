...
- (void)layoutSubviews {
	...
	[self setFrame:CGRectMake(0, 55, kScreen_Width, CGRectGetHeight(self.frame))];
    ...
    if (nil != self.labelText) {
        ...
        indFrame.origin.y -= (floorf(lHeight / 2 - 55 + PADDING / 2));
        indicator.frame = indFrame;
...
//    CGContextSetRGBStrokeColor(context, 41.0f, 75.0f, 208.0f, 0.8f); // white
//    CGContextSetRGBFillColor(context, 41.0f, 75.0f, 208.0f, 0.1f); // translucent white
