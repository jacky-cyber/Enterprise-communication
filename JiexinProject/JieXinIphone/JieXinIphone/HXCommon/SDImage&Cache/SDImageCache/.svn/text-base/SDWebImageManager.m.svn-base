...
- (void)imageDownloader:(SDWebImageDownloader *)downloader didFinishWithImage:(UIImage *)image
{
    ...
    for (NSInteger idx = [downloaders count] - 1; idx >= 0; idx--)
    {
        ...
        if (aDownloader == downloader)
        {
            ...
            //imageDownloader:(SDWebImageManager *)downloader didFailWithError:(NSError *)error
            else if(!image && [delegate respondsToSelector:@selector(imageDownloader:didFailWithError:)])
            {
...
//- (void)imageDownloader:(SDWebImageDownloader *)downloader didFinishWithImageData:(NSData *)imageDate
//{
//    
//}
@end
