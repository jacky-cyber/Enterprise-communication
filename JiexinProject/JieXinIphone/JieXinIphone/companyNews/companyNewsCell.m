...
@implementation companyNewsCell
...
-(void)setCellWithDic:(NSDictionary*)dic withIamge:(UIImage*)image{
       if ([[dic objectForKey:@"image"] isEqualToString:@"http://111.11.28.30:8087/newszq/page/titleImg/"]||[[dic objectForKey:@"image"] isEqualToString:@"http://111.11.28.9:8087/newszq/page/titleImg/"]) {
