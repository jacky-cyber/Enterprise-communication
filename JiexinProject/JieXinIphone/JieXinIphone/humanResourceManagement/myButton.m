...
//  JieXinIphone
//
//  Created by miaolizhuang on 14-6-16.
...
//初始化按钮
-(id)initButton:(NSString*)_title image:(NSString*)_image type:(enum ButtonType)_type fontSize:(int)_fontsize point:(CGPoint)_point tags:(int)_tags {
