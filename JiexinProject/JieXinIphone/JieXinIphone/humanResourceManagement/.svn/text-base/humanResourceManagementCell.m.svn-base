...
@implementation humanResourceManagementCell
...
-(void)addinitSubView{
    self.baseView=[[UIView alloc]initWithFrame:CGRectMake(10, 10, 300,self.height)];
    ...
    self.titleLabe=[[myTitleLabel alloc]initTitleLabel:nil   rect:CGRectZero fontSize:17 fontColor:nil];
    self.titleLabe.textAlignment=NSTextAlignmentLeft;
    [self.titleLabe setNumberOfLines:0];
    [baseView addSubview:self.titleLabe];
    
    self.dateLabel=[[myTitleLabel alloc]initTitleLabel:nil  rect:CGRectZero fontSize:12 fontColor:RGBCOLOR(117, 117, 117)];
    [self.dateLabel setNumberOfLines:1];
    self.dateLabel.textAlignment=NSTextAlignmentLeft;
    [baseView addSubview:self.dateLabel];
    
    self.contentLabel=[[myTitleLabel alloc]initTitleLabel:nil  rect:CGRectZero fontSize:15 fontColor:RGBCOLOR(23, 23, 23)];
